...
- [ ] `W9-S07` Extract `media_control` into `services_domains/home.py`.
- [ ] `W9-S08` Extract Home Assistant conversation/todo/timer/area handlers into `services_domains/home.py`.
- [ ] `W9-S09` Extract `smart_home` into `services_domains/home.py`.
...
- `services.py` reduced from `8,890` lines to `8,386` lines in this wave.
