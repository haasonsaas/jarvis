...
| `auth` | `smart_home`, `smart_home_state`, `home_assistant_capabilities`, `home_assistant_conversation`, `todoist_*`, `pushover_notify` |
| `cancelled` | `smart_home*`, `home_assistant_capabilities`, `home_assistant_conversation`, `todoist_*`, `pushover_notify` |
| `http_error` | `smart_home*`, `home_assistant_capabilities`, `home_assistant_conversation`, `todoist_*`, `pushover_notify` |
| `invalid_data` | `smart_home`, `home_assistant_conversation`, `timer_*`, `task_plan_*`, `memory_*` |
| `invalid_json` | `smart_home*`, `home_assistant_capabilities`, `home_assistant_conversation`, `todoist_*`, `pushover_notify` |
| `invalid_plan` | `task_plan_*` |
| `invalid_status` | `task_plan_update` |
| `invalid_steps` | `task_plan_create` |
| `missing_config` | `smart_home*`, `home_assistant_capabilities`, `home_assistant_conversation`, `todoist_*`, `pushover_notify` |
...
| `network_client_error` | `smart_home*`, `home_assistant_capabilities`, `home_assistant_conversation`, `todoist_*`, `pushover_notify` |
| `not_found` | `smart_home*`, `home_assistant_capabilities`, `home_assistant_conversation`, `timer_cancel`, `task_plan_*` |
...
| `timeout` | `smart_home*`, `home_assistant_capabilities`, `home_assistant_conversation`, `todoist_*`, `pushover_notify` |
